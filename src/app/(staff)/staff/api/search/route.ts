  ...
  try {
    ...
    return NextResponse.json({
      orders: orders.map((o) => ({
        ...
        subtitle: o.customer ? `${o.customer.firstName} ${o.customer.lastName}` : "Unknown Customer",
      ...
      invoices: invoices.map((i) => ({
        ...
        subtitle: i.customer ? `${i.customer.firstName} ${i.customer.lastName}` : "Unknown Customer",
