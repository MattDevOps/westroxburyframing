...
export default function ReportsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 space-y-8">
      ...
      {/* Quick links to standalone reports */}
      <div className="rounded-2xl border border-neutral-200 bg-white p-5 flex flex-wrap gap-3">
        <a
          href="/staff/reports/top-customers"
          className="px-4 py-2 bg-neutral-900 text-white rounded-xl text-sm font-medium hover:bg-neutral-800 inline-flex items-center gap-2"
        >
          📈 Top Customers by Lifetime Spend
        </a>
        <a
          href="/staff/reports/moulding-usage"
          className="px-4 py-2 bg-white border border-neutral-300 rounded-xl text-sm font-medium hover:bg-neutral-50 inline-flex items-center gap-2"
        >
          Moulding Usage
        </a>
      </div>
