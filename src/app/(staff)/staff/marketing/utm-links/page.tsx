...
const utmLinks: UTMLink[] = [
  {
    ...
    url: "https://westroxburyframing.com?utm_source=google&utm_medium=gbp&utm_campaign=profile",
    where: "Google Business Profile → Info → Website",
  },
  {
    platform: "Google Business Posts",
    description: "Link to use in Google Business posts",
    url: "https://westroxburyframing.com/book?utm_source=google&utm_medium=gbp&utm_campaign=posts",
    where: "When creating a Google Business post with a button link",
  },
  {
    platform: "Facebook",
    description: "Website link on your Facebook page",
    url: "https://westroxburyframing.com?utm_source=facebook&utm_medium=social&utm_campaign=page",
    where: "Facebook Page → About → Website",
  },
  {
    platform: "Facebook Posts",
    description: "Link to include in Facebook posts",
    url: "https://westroxburyframing.com?utm_source=facebook&utm_medium=social&utm_campaign=post",
    where: "When sharing links in Facebook posts",
  },
  {
    platform: "Instagram Bio",
    description: "Link in your Instagram bio",
    url: "https://westroxburyframing.com?utm_source=instagram&utm_medium=social&utm_campaign=bio",
    where: "Instagram → Edit Profile → Website",
  },
  {
    platform: "Yelp",
    description: "Website link on Yelp listing",
    url: "https://westroxburyframing.com?utm_source=yelp&utm_medium=listing&utm_campaign=profile",
    where: "Yelp Business Page → Website URL",
  },
  {
    platform: "Email Signature",
    description: "Link in email signatures",
    url: "https://westroxburyframing.com?utm_source=email&utm_medium=signature&utm_campaign=outbound",
    where: "Gmail/Outlook signature settings",
  },
  {
    platform: "Email Campaigns",
    description: "Links in marketing emails",
    url: "https://westroxburyframing.com?utm_source=email&utm_medium=campaign&utm_campaign=newsletter",
  ...
  },
  {
    ...
    url: "https://westroxburyframing.com/review?utm_source=qrcode&utm_medium=print&utm_campaign=review-card",
