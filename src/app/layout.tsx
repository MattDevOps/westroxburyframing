...
export const metadata: Metadata = {
  ...
  description:
    "Your local framer and custom frame shop in West Roxbury, MA since 1981. Picture framing for art, photos, diplomas, memorabilia, shadowboxes, restoration & more. Walk-ins welcome. Free parking.",
  keywords: [
    "framer",
    "frame",
    "frame shop",
