    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <Image src="/home/2024-legacy-award-mayor-wu.jpg" alt="West Roxbury Framing with Mayor Wu — 2024 Boston Legacy Business Award" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-foreground/70 leading-relaxed mb-6">
              Established in 1981, West Roxbury Framing Center is a family-owned and operated business with over 40 years of experience. We have served a high volume of clients over the years and take pride in giving great value for your money.
            </p>
            ...
            <p className="text-foreground/70 leading-relaxed mt-4">
              Moses Hasson is the owner of Copley Art &amp; Framing and West Roxbury Framing. He has been designing and building custom frames since 1981. He loves to work with customers to execute the perfect custom frame for their piece and give them the best price possible.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-muted-foreground mb-8">
            1741 Centre Street, West Roxbury, MA 02132 — free parking and walk-ins always welcome.
          </p>
