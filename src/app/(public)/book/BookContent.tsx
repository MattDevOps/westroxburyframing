      ...
      <section className="pt-32 pb-16 bg-secondary">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Schedule a complimentary framing consultation with us. Meet in person at our West Roxbury shop or talk over the phone about your artwork, photos, memorabilia, or project ideas.
          </p>
          <p className="text-muted-foreground max-w-2xl mx-auto mt-2 text-sm">
            Pick a day and time below. You&apos;ll be able to confirm whether you prefer an in-person or phone consultation in the booking form.
          </p>
        </div>
      </section>
